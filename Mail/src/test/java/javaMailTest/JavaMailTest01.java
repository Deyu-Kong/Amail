...
public class JavaMailTest01 {
    public static void main(String[] args) {
        ...
        props.put("mail.smtp.from", "发信地址");    //mailfrom 参数
        props.put("mail.user", "发信地址");// 发件人的账号(在控制台创建的发信地址)
        ...
        try {
            ...
            InternetAddress from = new InternetAddress("1518579103@qq.com", "孔德昱");//from 参数,可实现代发，注意：代发容易被收信方拒信或进入垃圾箱。
            message.setFrom(from);

            //可选。设置回信地址
            Address[] a = new Address[1];
            a[0] = new InternetAddress("1518579103@qq.com");
            message.setReplyTo(a);

            // 设置收件人邮件地址
            InternetAddress to = new InternetAddress("1518579103@qq.com");
